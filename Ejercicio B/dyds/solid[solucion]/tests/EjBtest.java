...
public class EjBtest {
	ManejadorGiftCards manejadorGiftCards;
	@Before
	public void setUp() throws Exception {
		SesionQuepasApp.getInstance().resetSingleton();
		manejadorGiftCards = new ManejadorGiftCards();
	}

	@Test
	public void testSinMsgs() {
		Compra compra = new Compra(100000, new Usuario(true));
		PremiosPorCompras premiosPorCompras = new PremiosPorCompras(manejadorGiftCards);
